...
class Form(Form):
        ...
        number_diagnoses = SelectField('number of diagnoses',choices=[(str(x), str(x)) for x in range(1,17)], validators=[validators.DataRequired()])
        num_procedures = SelectField('number of procedures',choices=[(str(x), str(x)) for x in range(0,7)], validators=[validators.DataRequired()])
        number_emergency = SelectField('number of emergency visits in the past year',choices=[(str(x), str(x)) for x in range(0,77)], validators=[validators.DataRequired()])
        number_outpatient = SelectField('number of outpatient visits in the past year',choices=[(str(x), str(x)) for x in range(0,43)], validators=[validators.DataRequired()])
        Discharged_to_home = SelectField('Discharged to home', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        Dicshared_to_rehab_fac = SelectField('Discharged/transferred to another rehab fac including rehab units of a hospital', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        gender_Male = SelectField('gender = male', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        payer_code_MC = SelectField('payer code = MC (Medicaid)', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        diag_1_Circulatory_System = SelectField('Diagnosis 1 = Diseases of the Circulatory System', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        diag_2_Circulatory_System = SelectField('Diagnosis 2 = Diseases of the Circulatory System', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        diag_3_Circulatory_System = SelectField('Diagnosis 3 = Diseases of the Circulatory System', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        age_70_80 = SelectField('Age = [70-80)', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        age_60_70 = SelectField('Age = [60-70)', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        race_Caucasian = SelectField('race = Caucasian', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        change_med_no = SelectField('No change in medication', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        age_80_90 = SelectField('Age = [80-90)', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        medical_specialty_InternalMedicine = SelectField("Physician's medical specialty = Internal Medicine", choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        admission_type_id_Emergency = SelectField('Admission type = Emergency', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        diag_3_External_Causes = SelectField('Diagnosis 3 = Supplementary Classification of External Causes of Injury And Poisoning', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        insulin_no = SelectField('Receiving insulin = no', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
        insulin_Steady = SelectField('Insulin = steady', choices=[(str(x), str(x)) for x in range(0,2)], validators=[validators.DataRequired()])
